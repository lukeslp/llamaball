...
def main(cli_args=None, omni_paths=None):
    ...
    # Quick start guide: common commands and usage tips
    console.print(Panel(
        textwrap.dedent("""\
[bold cyan]Quick Start Guide[/bold cyan]

[green]herd --dir /path/to/project[/green]             Run interactive CLI
[green]herd --gui[/green]                              Launch web-based GUI

[green]herd --dir /path/to/project --rename[/green]    Rename files
[green]herd --dir /path/to/project --snippets[/green]  Extract code snippets
[green]herd --dir /path/to/project --docs[/green]      Generate documentation
[green]herd --dir /path/to/project --citations[/green] Extract citations
[green]herd --dir /path/to/project --images[/green]    Process images

[dim]Use [green]herd --help[/green] for full options or press [?] in interactive mode[/dim]"""),
